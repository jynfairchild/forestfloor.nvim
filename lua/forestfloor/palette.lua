return {
	darker = {
		...
		-- Barbar (buffer tabs)
		barbar_bg = "#0F0F0F",               -- inactive tab background (matches toolbar)
		barbar_fg = "#7E7E7E",               -- inactive tab text
		barbar_active_bg = "#1E1E1E",        -- active tab background
		barbar_active_fg = "#CCCCCC",        -- active tab text
		barbar_modified = "#DE6767",         -- modified indicator
		barbar_visible_bg = "#161616",       -- visible (unfocused) tab background
		...
		lualine_inactive = "#6A6A6A",        -- inactive mode accent
