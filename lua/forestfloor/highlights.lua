...
local util = require("forestfloor.util")
...
hl.common = {
    ...
    SignColumn = { fg = c.grey, bg = cfg.transparent and c.none or c.bg0 },
    ToolbarLine = {fg = c.fg},
    ...
    CursorLine = { fg = c.complete_menu_predict, bg = c.bg0 },
    ...
    MsgArea = { fg = c.text_secondary, bg = c.none },
    -- search match sub
    ...
    Whitespace = { fg = c.grey_4 },
    SpecialKey = { fg = c.grey_4 },
    -- complete menus
    ...
    -- toolbar colors
    StatusLine = { fg = c.none, bg = c.lualine_bg_dark },
    StatusLineTerm = { fg = c.none, bg = c.lualine_bg_dark },
    StatusLineNC = { fg = c.none, bg = c.lualine_bg_dark },
    StatusLineTermNC = { fg = c.none, bg = c.lualine_bg_dark },
    ...
    VisualNOS = { fg = c.fg, bg = c.grey_3, fmt = "underline" },
...
hl.plugins.nvim_tree = {
    NvimTreeNormal = { fg = c.text_primary, bg = cfg.transparent and c.none or c.bg0 },
    NvimTreeVertSplit = { fg = c.line_separator, bg = cfg.transparent and c.none or c.bg0 },
    NvimTreeEndOfBuffer = { fg = cfg.ending_tildes and c.type_builtin or c.bg0, bg = cfg.transparent and c.none or c.bg0 },
...
hl.plugins.snacks = {
    ...
    SnacksPickerBorder = {fg = c.cyan},
    SnacksPickerTitle = {fg = c.red},
...
hl.plugins.indent_blankline = {
    ...
    IndentBlanklineChar = { fg = c.indent_breakline, fmt = "nocombine" },
    IndentBlanklineContextChar = { fg = c.indent_breakline, fmt = "nocombine" },
    IndentBlanklineContextStart = { sp = c.indent_breakline, fmt = "underline" },
    IndentBlanklineContextSpaceChar = { fmt = "nocombine" },

    -- Ibl v3
    IblIndent = { fg = c.indent_breakline, fmt = "nocombine" },
    IblWhitespace = { fg = c.indent_breakline, fmt = "nocombine" },
    IblScope = { fg = c.indent_breakline, fmt = "nocombine" },
}
...
function M.setup()
    ...
    local function replace_color(prefix, color_name)
        ...
        if color_name:sub(1, 1) == '$' then
            ...
            vim.notify('forestfloor.nvim: unknown color "' .. name .. '"', vim.log.levels.ERROR, { title = "forestfloor.nvim" })
                end)
                return ""
            end
        end
    ...
    for group_name, group_settings in pairs(vim.g.forestfloor_config.highlights) do
